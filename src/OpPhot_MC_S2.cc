...
void OpPhot_MC_S2(string datafile, string export_format, string bin_format, string suffix) {
	...
	sprintf(file_outname,"%s/%s_%s_plot_MC_S2.dat", workingdirectory.c_str(), suffix.c_str(), bin_format.c_str());
	...
	// generate plots  
	sprintf(file_outname,"%s/%s_%s_plot_MC_S2.root", workingdirectory.c_str(), suffix.c_str(),bin_format.c_str());
