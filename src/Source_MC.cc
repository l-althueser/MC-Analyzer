...
void Source_MC(string datafile, string export_format, string bin_format, string suffix) {
	...
	sprintf(canvasfile,"%s/%s_%s_xy.%s", workingdirectory.c_str(),suffix.c_str(),bin_format.c_str(),export_format.c_str());
	...
	sprintf(canvasfile,"%s/%s_%s_rZ.%s", workingdirectory.c_str(),suffix.c_str(),bin_format.c_str(),export_format.c_str());
	...
	if (elist_LXe_det->GetEntriesToProcess() > 0) {
		...
		sprintf(canvasfile,"%s/%s_%s_rZ_det.%s", workingdirectory.c_str(),suffix.c_str(),bin_format.c_str(),export_format.c_str());
		...
		sprintf(canvasfile,"%s/%s_%s_rZ_det_top.%s", workingdirectory.c_str(),suffix.c_str(),bin_format.c_str(),export_format.c_str());
		...
		sprintf(canvasfile,"%s/%s_%s_rZ_det_bottom.%s", workingdirectory.c_str(),suffix.c_str(),bin_format.c_str(),export_format.c_str());
