...
/*=================================================================*/
// OpPhot_MC_parameters("/path/to/file","png","LXeTR","OpPhotStudy");
...
void OpPhot_MC_parameters(string datafile, string export_format, string parameter, string suffix) {
	...
	if (fileexists(datafile) == false) {
		...
		if (files) {
			...
			while ((file=(TSystemFile*)next())) {
				...
				if (!file->IsDirectory() && fname.EndsWith(ext.c_str()) && !(fname.Contains(suffix.c_str()))) {
					...
					if (nevents>=10000000) {TPC.Set_Bins(30,50,22);}
		...
		if (param_value.size() != 0) {
			...
			g_AFT->GetYaxis()->SetTitle("AreaFractionTop [%]");
			...
			sprintf(canvasfile,"%s/%s_plot_MC_%s_AFT.eps", workingdirectory.c_str(),suffix.c_str(), parameter.c_str());
			if ((export_format!="eps")) c_AFT->SaveAs(canvasfile);
			...
			h_AFTZ.at(0)->SetYTitle("AreaFractionTop [%]");
			...
			sprintf(canvasfile,"%s/%s_plot_MC_%s_AFTZ.%s", workingdirectory.c_str(),suffix.c_str(), parameter.c_str(),export_format.c_str());
			if (!(export_format=="")) c_AFTZ->SaveAs(canvasfile);
			sprintf(canvasfile,"%s/%s_plot_MC_%s_AFTZ.eps", workingdirectory.c_str(),suffix.c_str(), parameter.c_str());
			if ((export_format!="eps")) c_AFTZ->SaveAs(canvasfile);
			...
			mg_LCE->GetYaxis()->SetTitle("LightCollectionEfficiency [%]");
			...
			sprintf(canvasfile,"%s/%s_plot_MC_%s_LCE.%s", workingdirectory.c_str(),suffix.c_str(), parameter.c_str(),export_format.c_str());
			if (!(export_format=="")) c_LCE->SaveAs(canvasfile);
			sprintf(canvasfile,"%s/%s_plot_MC_%s_LCE.eps", workingdirectory.c_str(),suffix.c_str(), parameter.c_str());
			if ((export_format!="eps")) c_LCE->SaveAs(canvasfile);
			...
			h_LCEZ_sum.at(0)->SetYTitle("LightCollectionEfficiency [%]");
			...
			sprintf(canvasfile,"%s/%s_plot_MC_%s_LCEZ.%s", workingdirectory.c_str(),suffix.c_str(), parameter.c_str(),export_format.c_str());
			if (!(export_format=="")) c_LCEZ->SaveAs(canvasfile);
			sprintf(canvasfile,"%s/%s_plot_MC_%s_LCEZ.eps", workingdirectory.c_str(),suffix.c_str(), parameter.c_str());
			if ((export_format!="eps")) c_LCEZ->SaveAs(canvasfile);
			...
			h_rLCEZ_sum->SetYTitle("relative LightCollectionEfficiency");
			...
			sprintf(canvasfile,"%s/%s_plot_MC_%s_rLCEZ.%s", workingdirectory.c_str(),suffix.c_str(), parameter.c_str(),export_format.c_str());
			if (!(export_format=="")) c_rLCEZ->SaveAs(canvasfile);
			sprintf(canvasfile,"%s/%s_plot_MC_%s_rLCEZ.eps", workingdirectory.c_str(),suffix.c_str(), parameter.c_str());
			if ((export_format!="eps")) c_rLCEZ->SaveAs(canvasfile);
		}
		...
		if (param_value_S2.size() != 0) {
			...
			g_AFT_S2->GetYaxis()->SetTitle("AreaFractionTop [%]");
			...
			sprintf(canvasfile,"%s/%s_plot_MC_%s_AFTS2.%s", workingdirectory.c_str(),suffix.c_str(), parameter.c_str(),export_format.c_str());
			if (!(export_format=="")) c_AFT_S2->SaveAs(canvasfile);
			sprintf(canvasfile,"%s/%s_plot_MC_%s_AFTS2.eps", workingdirectory.c_str(),suffix.c_str(), parameter.c_str());
			if ((export_format!="eps")) c_AFT_S2->SaveAs(canvasfile);
		}
